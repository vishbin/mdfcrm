...
public class ItineraryFormBean extends ActionForm {
	...
	public void setPax1_first_name(String pax1_first_name) {
		this.pax1_first_name = pax1_first_name.toUpperCase().trim();
	}
	...
	public void setPax1_last_name(String pax1_last_name) {
		this.pax1_last_name = pax1_last_name.toUpperCase().trim();
	}
	...
	public void setPax1_middle_name(String pax1_middle_name) {
		this.pax1_middle_name = pax1_middle_name.toUpperCase().trim();
	}
	...
	public void setPax1_title(String pax1_title) {
		this.pax1_title = pax1_title.toUpperCase().trim();
	}
	...
	public void setPax2_first_name(String pax2_first_name) {
		this.pax2_first_name = pax2_first_name.toUpperCase().trim();
	}
	...
	public void setPax2_last_name(String pax2_last_name) {
		this.pax2_last_name = pax2_last_name.toUpperCase().trim();
	}
	...
	public void setPax2_middle_name(String pax2_middle_name) {
		this.pax2_middle_name = pax2_middle_name.toUpperCase().trim();
	}
	...
	public void setPax2_title(String pax2_title) {
		this.pax2_title = pax2_title.toUpperCase().trim();
	}
	...
	public void setPax3_first_name(String pax3_first_name) {
		this.pax3_first_name = pax3_first_name.toUpperCase().trim();
	}
	...
	public void setPax3_last_name(String pax3_last_name) {
		this.pax3_last_name = pax3_last_name.toUpperCase().trim();
	}
	...
	public void setPax3_middle_name(String pax3_middle_name) {
		this.pax3_middle_name = pax3_middle_name.toUpperCase().trim();
	}
	...
	public void setPax3_title(String pax3_title) {
		this.pax3_title = pax3_title.toUpperCase().trim();
	}
	...
	public void setPax4_first_name(String pax4_first_name) {
		this.pax4_first_name = pax4_first_name.toUpperCase().trim();
	}
	...
	public void setPax4_last_name(String pax4_last_name) {
		this.pax4_last_name = pax4_last_name.toUpperCase().trim();
	}
	...
	public void setPax4_middle_name(String pax4_middle_name) {
		this.pax4_middle_name = pax4_middle_name.toUpperCase().trim();
	}
	...
	public void setPax4_title(String pax4_title) {
		this.pax4_title = pax4_title.toUpperCase().trim();
	}
	...
	public void setPax5_first_name(String pax5_first_name) {
		this.pax5_first_name = pax5_first_name.toUpperCase().trim();
	}
	...
	public void setPax5_last_name(String pax5_last_name) {
		this.pax5_last_name = pax5_last_name.toUpperCase().trim();
	}
	...
	public void setPax5_middle_name(String pax5_middle_name) {
		this.pax5_middle_name = pax5_middle_name.toUpperCase().trim();
	}
	...
	public void setPax5_title(String pax5_title) {
		this.pax5_title = pax5_title.toUpperCase().trim();
	}
